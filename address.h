...
namespace pkodev
{
	namespace address
	{
        ...
        namespace GAME_13X_0
        {
            ...
            const unsigned int CCharacter__setSideID = 0x004A2840;

            // void NetSwitchMap(stNetSwitchMap &switchmap)
            const unsigned int NetSwitchMap = 0x00507090;

            // void CGameScene::_RenderUI()
            const unsigned int CGameScene___RenderUI = 0x004D9210;
        ...
        namespace GAME_13X_1
        {
            ...
            // void CCharacter::setSideID(long side_id)
            const unsigned int CCharacter__setSideID = 0x004A2950;

            // void NetSwitchMap(stNetSwitchMap &switchmap)
            const unsigned int NetSwitchMap = 0x005071A0;

            // void CGameScene::_RenderUI()
            const unsigned int CGameScene___RenderUI = 0x004D9320;
        ...
        namespace GAME_13X_2
        {
            ...
            // void CCharacter::setSideID(long side_id)
            const unsigned int CCharacter__setSideID = 0x004A29F0;

            // void NetSwitchMap(stNetSwitchMap &switchmap)
            const unsigned int NetSwitchMap = 0x00507270;

            // void CGameScene::_RenderUI()
            const unsigned int CGameScene___RenderUI = 0x004D93F0;
        ...
        namespace GAME_13X_3
        {
            ...
            // void CCharacter::setSideID(long side_id)
            const unsigned int CCharacter__setSideID = 0x004A29E0;

            // void NetSwitchMap(stNetSwitchMap &switchmap)
            const unsigned int NetSwitchMap = 0x00507260;

            // void CGameScene::_RenderUI()
            const unsigned int CGameScene___RenderUI = 0x004D93E0;
        ...
        namespace GAME_13X_4
        {
            ...
            // void CCharacter::setSideID(long side_id)
            const unsigned int CCharacter__setSideID = 0x004A2C20;

            // void NetSwitchMap(stNetSwitchMap &switchmap)
            const unsigned int NetSwitchMap = 0x00507480;

            // void CGameScene::_RenderUI()
            const unsigned int CGameScene___RenderUI = 0x004D95C0;
        ...
        namespace GAME_13X_5
        {
            ...
            // void CCharacter::setSideID(long side_id)
            const unsigned int CCharacter__setSideID = 0x004A2640;

            // void NetSwitchMap(stNetSwitchMap &switchmap)
            const unsigned int NetSwitchMap = 0x00506F00;

            // void CGameScene::_RenderUI()
            const unsigned int CGameScene___RenderUI = 0x004D9040;
